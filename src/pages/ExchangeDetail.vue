<template>
  <div class="page-wrapper" v-if="exchange && exchange.slug">
              ...
              <div class="column-right">
                <div class="card">
                  ...
                  <div class="card-content">
                    ...
                    <router-link
                      class="button isFullwidth is-large is-success is-outline"
                      to="/login"
                      v-if="!isAuth"
...
export default {
  ...
  computed: {
    ...
    exchangeOwner() {
      return this.$store.getters["user/exchangeOwner"](this.exchangeUser.id);
    },
    canCreateExchange() {
      return this.isAuth && !this.exchangeOwner;
    },
  },
};
</script>
